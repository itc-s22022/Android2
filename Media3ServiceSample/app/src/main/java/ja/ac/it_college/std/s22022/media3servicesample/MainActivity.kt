package ja.ac.it_college.std.s22022.media3servicesample
...
import ja.ac.it_college.std.s22022.media3servicesample.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun playSample() {
        ...
        controller.setMediaItem(
            MediaItem.fromUri("android.resource://${packageName}/${R.raw.ame}")
        )
