package ja.ac.it_college.std.s22022.mediasample
...
import ja.ac.it_college.std.s22022.mediasample.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mediaFileUri = Uri.parse(
            "android.resource://${packageName}/${R.raw.ame}"
        )
        mediaPlayer?.apply {
